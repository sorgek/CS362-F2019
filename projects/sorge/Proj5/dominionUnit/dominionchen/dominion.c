...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
		...
		MineCard(choice1, choice2, state, currentPlayer);
		return 0;
    ...
    case minion:
		...
		MinionCard(choice1, choice2, state, currentPlayer, handPos, handCount);
		return 0;
    ...
    case ambassador:
		Ambassadorcard(choice1, choice2, handPos, state, currentPlayer);
		return 0;
...
int Minioncard(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer, int handCount)
//+1 action
state->numActions++;
//discard card from hand
discardCard(handPos, currentPlayer, state, 0);
...
int TributeCard(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer, int nextPlayer)

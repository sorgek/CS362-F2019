...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return mineCard(currentPlayer, choice1, choice2, state, handPos);
    ...
    case minion:
        ...
        minionCard(currentPlayer, choice1, choice2, state, handPos);
    ...
    case ambassador:
        ...
        return ambassadorCard(currentPlayer, choice1, choice2, state, handPos);
...
int ambassadorCard(int currentPlayer, int toDiscard, int numToDiscard, struct gameState *state, int handPos){
	...
	for (i = 0; i < state->handCount[currentPlayer]; i++)
	{
		if (i != handPos && i == state->hand[currentPlayer][toDiscard] /*&& i != toDiscard*/)
		{
			j++;
		}
	}
